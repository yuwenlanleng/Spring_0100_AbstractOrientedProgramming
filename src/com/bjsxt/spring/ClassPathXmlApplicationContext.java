...
//		</beans>
	    ...
	    for(int i=0;i<list.size();i++){
	       ...
	       String clazz=element.getAttributeValue("class");//com.bjsxt.dao.impl.UserDAOImpl或则com.bjsxt.service.UserService
	       ...
	       for(Element propertyElement : (List<Element>)element.getChildren("property")) {
	    	   ...
	    	   Object beanObject = beans.get(bean);//com.bjsxt.dao.impl.UserDAOImpl
